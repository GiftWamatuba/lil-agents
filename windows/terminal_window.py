...
class TerminalWindow:
    ...
    def _build(self):
        ...
        lbl = tk.Label(
            header, text=label_text, bg=header_bg,
        ...
        close_font = tkFont.Font(family='Helvetica', size=12, weight='bold')
        close_btn = tk.Button(
            header, text='×', bg=header_bg, fg=text_col,
            font=close_font, relief='flat', bd=0,
        ...
        text = tk.Text(
            msg_frame, bg=bg, fg=text_col,
            font=msg_font, wrap='word',
        ...
        text.tag_configure('system',    font=tkFont.Font(
            family='Helvetica', size=11, slant='italic'),
            foreground='#888888')
        ...
        inp = tk.Text(
            input_frame, bg=input_bg, fg=text_col,
            font=input_font, wrap='word', relief='flat',
        ...
        send_font = tkFont.Font(family='Helvetica', size=11, weight='bold')
        send_btn = tk.Button(
            input_frame, text='▶', bg=_to_hex(theme['accent']),
            fg='white', font=send_font, relief='flat',
    ...
    def _insert_inline_markup(self, text, default_tag):
        ...
        while True:
            ...
            self._text.insert('end', text[start + 2:close], 'user')  # bold
            pos = close + 2
    ...
    def update_provider(self, provider_name, theme_name=None):
        ...
        if self._input:
            self.root.after(
                0, lambda: self._input.configure(
                    foreground=_to_hex(self.theme['text'])))
